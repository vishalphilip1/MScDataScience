...
This script consists of functions for plotting line charts, bar charts and pie charts using matplotlib library. 
...
data1 = pd.read_excel(r"C:\Users\acer\OneDrive - University of Hertfordshire\Assignment\Applied data science\Assignment1\Mobile Cellular Subscription per 100.xlsx")
...
line_plot(data2.Year, data2.Bangladesh, "SriLanka","violet")
#Creating labels
